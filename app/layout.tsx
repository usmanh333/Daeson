...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Islamic banking software for financial institutions",
    "Islamic banking software vendors",
    "Islamic banking software provider",
    "Islamic banking software solutions",
    "Islamic retail banking software",
    "Islamic core banking software",
    "Murabaha financing software",
    "Murabaha software",
    "Shariah compliant banking software",
    "Shariah compliance intelligence",
    "Islamic finance AI platform",
    "Islamic finance technology",
    "bank compliance software",
    "microfinance bank software",
    "Islamic bank software Pakistan",
    "Islamic bank software Europe",
    "Ask Aylinor",
  ],
  authors: [
