...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE}/insights/shariah-compliant-software-future`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.75 },
    { url: `${BASE}/insights/home-1-0-residential-property-management`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.75 },
    { url: `${BASE}/insights/murabaha-contract-review-bottleneck`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.75 },
    { url: `${BASE}/insights/shariah-governance-audit-trail`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.75 },
